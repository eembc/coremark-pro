...
TOOL_AL_DIRS = al/fdlibm 
TOOL_AL_SRCS = $(wildcard $(TOPME)/al/fdlibm/*.c)
...
COMPILER_FLAGS = -O1 $(CDEFN)NDEBUG $(CDEFN)HOST_EXAMPLE_CODE=1 -std=gnu99 -mfpmath=sse -msse2
COMPILER_NOOPT = -g -O0 $(CDEFN)NDEBUG $(CDEFN)HOST_EXAMPLE_CODE=1 -mfpmath=sse -msse2
COMPILER_DEBUG = -O0 -g $(CDEFN)HOST_EXAMPLE_CODE=1 -DBMDEBUG=1 -DTHDEBUG=1 -mfpmath=sse -msse2
PACK_OPTS = 
