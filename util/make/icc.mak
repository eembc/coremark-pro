...
COMPILER_NOOPT	= -g -O0 $(CDEFN)NDEBUG $(CDEFN)HOST_EXAMPLE_CODE=1 -std=gnu99
COMPILER_DEBUG	= -O0 -g $(CDEFN)HOST_EXAMPLE_CODE=1 -DBMDEBUG=1 -DTHDEBUG=1 -mp -std=gnu99
PACK_OPTS = 
...
%$(OEXT) : %.c $(EXTRA_DEPS)
	...
	$(CC) $(COBJT) $(CFLAGS) $(WARNING_OPTIONS) $(BENCH_CFLAGS) $(XCFLAGS) $(KERNEL_DEFINES) $(WORKLOAD_DEFINES) $(INC_FLAGS) $$SRC_NAME $(OBJOUT) $@
endif
