 ...
 *          $Author: rick $
 *          $Source: D:/cvs/eembc2/consumer/cjpegv2/jcprepct.c,v $
 *          
 * NOTE   :
 *
 *------------------------------------------------------------------------------
 ...
 *
 * Revision 1.4  2004/01/22 20:16:54  rick
 * Copyright update and cleanup
 *
 * Revision 1.3  2002/04/22 22:54:52  rick
 ...
 */
/* NO CONTEXT OR SMOOTHING OPTIONS */
            ...
            int input_rows, int output_rows)
{
  ...
  for (row = input_rows; row < output_rows; row++) {
    cjcopy_sample_rows(image_data, input_rows-1, image_data, row,
              1, num_cols);
  }
}
