 ...
 *          $Author: rick $
 *          $Source: D:/cvs/eembc2/consumer/cjpegv2/jccoefct.c,v $
 *          
 * NOTE   :
 *
 *------------------------------------------------------------------------------
 ...
 */
/* NOT USING OPT. or MULTISCAN */
#undef FULL_COEF_BUFFER_SUPPORTED
    ...
    for (yindex = 0; yindex < compptr->MCU_height; yindex++) {
      if (coef->iMCU_row_num < last_iMCU_row ||
        ...
        if (blockcnt < compptr->MCU_width) {
          ...
          cjzero_far((void FAR *) coef->MCU_buffer[blkn + blockcnt],
        ...
        cjzero_far((void FAR *) coef->MCU_buffer[blkn],
